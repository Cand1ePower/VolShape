...
function DesktopSidebarTabBar({ state, descriptors, navigation, isDark }: any) {
  return (
    <View
      style={
        {
        ...
        return (
          <Pressable
            ...
            style={{
              ...
              alignItems: 'center',
              justifyContent: 'center',
              backgroundColor: isFocused ? (isDark ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.03)') : 'transparent',
            }}
          >
            {icon}
          </Pressable>
        ...
        <Tabs
          ...
          screenOptions={{
            ...
            tabBarStyle: {
              ...
              backgroundColor: isDark ? 'rgba(20, 20, 26, 0.9)' : 'rgba(255, 255, 255, 0.92)',
              borderTopWidth: 0.5,
